...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            LimitX1 = engine.CameraLimitX1 - 10;
            LimitY1 = engine.CameraLimitY1 - 10;
        ...
        private void Update()
        {
            ...
            LimitX2 = engine.CameraLimitX2 + 10;
            LimitY2 = engine.CameraLimitY2 + 10;
        }
        ...
        private void LimitPosition()
        {
            ...
            m_Transform.position = new Vector3(Mathf.Clamp(m_Transform.position.x, LimitX1, LimitX2),
                m_Transform.position.y,
                Mathf.Clamp(m_Transform.position.z, LimitY1, LimitY2));
        }
