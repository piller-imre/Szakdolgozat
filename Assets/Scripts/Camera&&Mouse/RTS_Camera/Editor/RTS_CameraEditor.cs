...
namespace RTS_Cam
{
    ...
    public class RTS_CameraEditor : Editor
    {
        ...
        private void MovementTab()
        {
            ...
            if (camera.limitMap)
            {
                camera.LimitX1 = EditorGUILayout.FloatField("Limit X Side 1: ", camera.LimitX1);
                camera.LimitX2 = EditorGUILayout.FloatField("Limit X Side 2: ", camera.LimitX2);
                camera.LimitY1 = EditorGUILayout.FloatField("Limit Y Side 1: ", camera.LimitY1);
                camera.LimitY2 = EditorGUILayout.FloatField("Limit Y Side 2: ", camera.LimitY2);
            }
