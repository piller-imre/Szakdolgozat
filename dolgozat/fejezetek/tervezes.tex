...
\caption{Egy épület normál körülmények között (bal oldal) és havas körülmények között (jobb oldal). www.assetstore.unity3d.com/en/\#!/content/50095}
\label{fig:Buildings}
\end{figure}
...
\caption{Normál esetben a fák lombja a zöld különböző árnyalataiból állhat. www.assetstore.unity3d.com/en/\#!/content/52217}
...
\caption{“Ősz” A lomb színei ebben az esetben több különböző szín árnyalatából tevődik össze (piros, barna, sárga). www.assetstore.unity3d.com/en/\#!/content/52217}
\label{fig:Tree_Fall}
\end{figure}
...
\caption{Kiszáradt vagy jeges Ebben az esetben mint látható az algoritmus elrejti a lombokat. www.assetstore.unity3d.com/en/\#!/content/52217}
...
\caption{Virágok www.assetstore.unity3d.com/en/\#!/content/47083}
\label{fig:Flowers}
\end{figure}
...
www.assetstore.unity3d.com/en/\#!/content/11547}
\label{fig:Cactus}
\end{figure}
